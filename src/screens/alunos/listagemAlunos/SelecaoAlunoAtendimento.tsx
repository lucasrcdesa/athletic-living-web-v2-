...
const SelecaoAlunoAtendimento = ({ tipo }: { tipo: 'marcar' | 'editar' }) => {
  ...
  const handleRowClick = (row: any) => {
    if (tipo === 'marcar') {
      navigate(`/atendimentos/marcar/${row.id}`);
    } else {
  ...
  if (loading) {
    return (
      <div className="app-container">
        <HeaderPages title={tipo === 'marcar' ? "Marcar Atendimento - Selecione o Aluno" : "Editar Atendimento - Selecione o Aluno"} />
...
export default SelecaoAlunoAtendimento; 