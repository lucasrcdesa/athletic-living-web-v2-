...
import "./ListagemNotificacoesAluno.css";
...
const ListagemNotificacoesAluno = () => {
  ...
  const { listarNotificacoesPorAluno, deletarNotificacao } = NotificacaoCadastroService();
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        const notificacoesData = await listarNotificacoesPorAluno(parseInt(id));
  ...
  if (loading) {
    return (
      <div className="app-container">
        <HeaderPages title="Notificações do Aluno" />
  ...
  return (
    <div className="app-container">
      <HeaderPages title={`Notificações - ${aluno.nome}`} />
      ...
      <div className="listagem-container">
        <div className="table-header">
          <h2>Notificações de {aluno.nome}</h2>
          <button 
...
export default ListagemNotificacoesAluno; 