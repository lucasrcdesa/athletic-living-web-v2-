  ...
  if (loading) {
    return (
      <div className="app-container">
        <HeaderPages title="Periodizações - Selecione o Aluno" />
  ...
  return (
    <div className="app-container">
      ...
      <div className="listagem-container">
        <DataTable
          title="Selecione um aluno para ver as periodizações"
          columns={columns}
          data={alunos}
...
export default SelecaoAlunoPeriodizacao; 