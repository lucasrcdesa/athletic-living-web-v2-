...
const SelecaoAlunoAvaliacao = () => {
  ...
  const handleRowClick = (row: any) => {
    navigate(`/avaliacao/incluir/${row.id}`);
  };

  if (loading) {
    return (
      <div className="app-container">
        <HeaderPages title="Avaliações - Selecione o Aluno" />
...
export default SelecaoAlunoAvaliacao; 